...
(/** @lends <global> */function( $ ) {
	 ...
	 *  @param array {nodes} aN1 Another list (identical structure to the first) - optional
	 *  @memberof DataTable#oApi
	 */
	function _fnApplyToChildren( fn, an1, aN1 )
	{
		...
		while ( i < iLen ) {
			...
			nNode2 = aN1 ? aN1[i].firstChild : null;
			...
			while ( nNode1 ) {
				...
				nNode2 = aN1 ? nNode2.nextSibling : null;
			}
